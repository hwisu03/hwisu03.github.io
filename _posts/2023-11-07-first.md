...
노이즈의 예시로 단순 선형회귀 모형의 오차항이 있음.<br>

$$ y = b_0 + b_1 x + epsilon_0 $$
...
선형의 의미: 2차원에서의 직선, 3차원에서의 평면, 4차원 이상에서의 hyperplane이 선형이고, 선형은 각 변수에 어떠한 상수항을 곱하고, 그것들 끼리의 덧셈으로만 이루어진 관계이다.
